      ...
      {slides.length > 1 && (
        <>
          <button
            ...
            className="hidden sm:grid absolute left-4 top-1/2 -translate-y-1/2 place-items-center w-12 h-12 rounded-full bg-white/20 backdrop-blur text-white hover:bg-white hover:text-foreground transition squish"
          >
