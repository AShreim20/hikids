...
export default function ProductListRow({ product: p, onEdit, onDelete }) {
  const { t, formatPrice } = useLanguage();
  return (
    <div className="flex items-center gap-4 p-3 sm:p-4 rounded-3xl bg-card border border-border/60">
