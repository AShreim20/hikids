  ...
  return (
    <>
      <button
        ...
        aria-expanded={open}
        className="fixed z-50 bottom-20 md:bottom-6 start-4 md:start-6 inline-flex items-center gap-2 h-14 w-14 md:w-auto md:px-5 justify-center rounded-full bg-cosmic text-white shadow-lg shadow-cosmic/30 squish focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-cosmic/40"
      >
