...
export default function MobileNav() {
  ...
  // Product, Cart, Checkout and the Return wizard have their own sticky action bar; hide this bar there so two fixed bars never overlap.
  if (pathname.startsWith('/product/') || pathname === '/cart' || pathname === '/checkout' || pathname.startsWith('/returns/new/')) return null;
