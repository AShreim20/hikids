    ...
    <>
      ...
      <header className="md:hidden sticky top-0 z-50 bg-background/90 backdrop-blur-xl border-b border-border/60 safe-top">
        <div className="flex items-center gap-2 h-16 px-3">
          {isTopLevel ? <span className="w-12 h-12 shrink-0" aria-hidden /> : <button
            onClick={handleBack}
            className="squish relative grid place-items-center w-12 h-12 rounded-full bg-mist text-foreground shrink-0 after:absolute after:-inset-1 after:content-['']"
          ...
          {pathname !== '/cart' && pathname !== '/checkout' && (
            <Link to="/cart" className="relative grid place-items-center w-12 h-12 rounded-full bg-mist shrink-0 after:absolute after:-inset-1 after:content-['']" aria-label={t('nav.cart')}>
          ...
          <Link
            to="/"
            className="relative grid place-items-center h-12 min-w-12 px-3 rounded-full bg-mist shrink-0 after:absolute after:-inset-1 after:content-['']"
